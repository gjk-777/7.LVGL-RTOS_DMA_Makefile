...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btnm_1, 57, 74);
    lv_obj_set_size(ui->screen_btnm_1, 204, 158);
    ...
    lv_obj_set_pos(ui->screen_cont_1, 60, 16);
    lv_obj_set_size(ui->screen_cont_1, 199, 45);
    ...
    lv_label_set_text(ui->screen_label_1, "密码:");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 4, 13);
    lv_obj_set_size(ui->screen_label_1, 49, 19);
    ...
    //Write codes screen_Password_Lable
    ui->screen_Password_Lable = lv_label_create(ui->screen_cont_1);
    lv_label_set_text(ui->screen_Password_Lable, "");
    lv_label_set_long_mode(ui->screen_Password_Lable, LV_LABEL_LONG_SCROLL_CIRCULAR);
    lv_obj_set_pos(ui->screen_Password_Lable, 53, 12);
    lv_obj_set_size(ui->screen_Password_Lable, 133, 20);

    //Write style for screen_Password_Lable, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_Password_Lable, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_Password_Lable, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_Password_Lable, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_Password_Lable, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_Password_Lable, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
