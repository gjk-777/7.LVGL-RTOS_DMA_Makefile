...
void screen_1_digital_clock_1_timer(lv_timer_t *timer)
{
    ...
    {
        lv_dclock_set_text_fmt(guider_ui.screen_1_digital_clock_1, "%d:%02d:%02d %s", screen_1_digital_clock_1_hour_value, screen_1_digital_clock_1_min_value, screen_1_digital_clock_1_sec_value, screen_1_digital_clock_1_meridiem);
    }
}
void lv_screen_2_spinbox_1_increment_event_cb(lv_event_t * event)
{
    ...
    if(code == LV_EVENT_SHORT_CLICKED || code == LV_EVENT_LONG_PRESSED_REPEAT) {
        lv_spinbox_increment(guider_ui.screen_2_spinbox_1);
    }
}
void lv_screen_2_spinbox_1_decrement_event_cb(lv_event_t * event)
{
    lv_event_code_t code = lv_event_get_code(event);
    if(code == LV_EVENT_SHORT_CLICKED || code == LV_EVENT_LONG_PRESSED_REPEAT) {
        lv_spinbox_decrement(guider_ui.screen_2_spinbox_1);
    }
}
