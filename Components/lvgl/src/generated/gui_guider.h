...
typedef struct
{
	...
	lv_obj_t *screen_2_meter_1;
	lv_meter_scale_t *screen_2_meter_1_scale_0;
	lv_meter_indicator_t *screen_2_meter_1_scale_0_ndline_0;
	lv_obj_t *screen_2_spinbox_1;
	lv_obj_t *screen_2_spinbox_1_btn_plus;
	lv_obj_t *screen_2_spinbox_1_btn_minus;
	lv_obj_t *screen_2_roller_1;
...
LV_IMG_DECLARE(_ledoff_alpha_30x30);
LV_IMG_DECLARE(_clock_alpha_30x30);
LV_IMG_DECLARE(_ledoff_alpha_30x30);
LV_IMG_DECLARE(_led0_alpha_30x30);
LV_IMG_DECLARE(_led1_alpha_30x30);
